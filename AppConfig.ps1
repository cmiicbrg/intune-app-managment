...
$script:AppConfigurations = @{
    Firefox = @{
        ...
        Publisher = "Mozilla"
        Description = "Mozilla Firefox web browser - German version {0}+ (auto-updates enabled) - Deployed automatically"
        Folder = "firefox"
    ...
    Chrome = @{
        ...
        Description = "Google Chrome Enterprise web browser - Version {0}+ (auto-updates enabled) - Deployed automatically"
        Folder = "chrome"
    ...
    SevenZip = @{
        ...
        Description = "7-Zip file archiver - Version {0} - Deployed automatically"
        Folder = "7zip"
    ...
    GIMP = @{
        ...
        Description = "GIMP - GNU Image Manipulation Program - Version {0} (exact) - Deployed automatically"
        Folder = "gimp"
    ...
    VLC = @{
        ...
        Publisher = "VideoLAN"
        Description = "VLC media player - Version {0} (exact) - Deployed automatically"
        Folder = "vlc"
    ...
    NotepadPlusPlus = @{
        ...
        Description = "Notepad++ text and source code editor - Version {0} (exact) - Deployed automatically"
        Folder = "npp"
    ...
    AffinityStudio = @{
        ...
        Publisher = "Affinity"
        Description = "Affinity Studio - Creative suite for design, photo editing, and publishing - Deployed automatically"
        Folder = "affinity"
    ...
    Inkscape = @{
        ...
        Description = "Inkscape - Professional vector graphics editor - Deployed automatically"
        Folder = "inkscape"
    ...
    Audacity = @{
        ...
        Description = "Audacity - Free, open source, cross-platform audio software - Deployed automatically"
        Folder = "audacity"
    ...
    LibreOffice = @{
        ...
        Description = "LibreOffice - Free and powerful office suite - German version (Enterprise/Business) - Deployed automatically"
        Folder = "libreoffice"
    ...
    OpenShot = @{
        ...
        Description = "OpenShot Video Editor - Free, open-source video editor - Version {0}+ - Deployed automatically"
        Folder = "openshot"
